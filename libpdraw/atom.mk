...
$(LOCAL_BUILD_DIR)/$(PDRAW_PYTHON_SWIG_WRAPPER): $(LOCAL_PATH)/$(PDRAW_PYTHON_SWIG_SOURCE) $(PDRAW_PYTHON_SWIG_DEPENDS)
	...
	$(Q) cp $(LOCAL_BUILD_DIR)/$(PDRAW_PYTHON_NAME).py $(PDRAW_PYTHON_DESTDIR)
