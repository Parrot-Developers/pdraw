...
LOCAL_LIBRARIES := \
	...
	curl \
	libpng
LOCAL_CFLAGS += -I$(SDKSTAGE)/opt/vc/include -DSTANDALONE \
...
LOCAL_LDLIBS += -L$(SDKSTAGE)/opt/vc/lib -lbrcmGLESv2 -lbrcmEGL -lopenmaxil \
	-lbcm_host -lvcos -lvchiq_arm -lpthread -lrt -lm \
